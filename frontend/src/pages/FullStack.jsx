    ...
    <div>
      ...
      <section id="mern" className="scroll-section">
        <InfoBlock
          ...
          content="Our MERN Stack program empowers learners to build modern, high-performance web
      ...
      <section id="mean" className="scroll-section">
        <InfoBlock
          ...
          content="Our MEAN Stack program focuses on full-stack development using MongoDB,
