...
const Contact = () => {
  ...
  return (
    ...
    <div className="flex items-center flex-col mt-8 font-medium">
    <p className='text-2xl'>Contact us today to explore collaboration opportunities or to learn more about our services.</p>
        <ul className=" flex justify-center ml-4 text-xl font-light mt-5 space-y-2 flex-col">
          <li >📞 Phone: 99406 42303</li>
          <li >📧 Email: info@immt.com</li>
          <li >🏢 Address: 2/208A, North 1st Street, near MKU, Kalvi Nagar, Quarters, Rajambadi, Nagamalaipudukottai, Madurai, Tamil Nadu 625019</li>
        </ul>
    </div>
